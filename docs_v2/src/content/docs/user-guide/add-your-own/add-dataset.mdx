---
title: Add dataset
import { Steps, Step } from 'starlight/components';
---
...
<Steps>
  ...
  <Step title="Set Up a Custom Dataset Class">
  ...
  <Step title="Implement the format_item Method">
  ...
  <Step title="Iterate Over the Dataset">
  ...
  <Step title="Handle Model Output">
  ...
  <Step title="Yield Examples for Evaluation">
