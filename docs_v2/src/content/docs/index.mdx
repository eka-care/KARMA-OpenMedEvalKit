...
description: Knowledge Assessment and Reasoning for Medical Applications - An evaluation framework for medical AI models.
tableOfContents: false
hero:
  tagline: Knowledge Assessment and Reasoning for Medical Applications - An evaluation framework for medical AI models.
  image:
...
## Release resources
<LinkCard
  title="KARMA release blog"
  href="http://info.eka.care/services/introducing-karma-openmedevalkit-an-open-source-framework-for-medical-ai-evaluation"
  description="Read about KARMA"
/>
<LinkCard
  title="4 novel healthcare datasets"
  href=" http://info.eka.care/services/advancing-healthcare-ai-evaluation-in-india-ekacare-releases-four-evaluation-datasets"
  description="Read about the datasets released along with KARMA"
/>
<LinkCard
  title="Beyond WER - SemWER"
  href="http://info.eka.care/services/beyond-traditional-wer-the-critical-need-for-semantic-wer-in-asr-for-indian-healthcare"
  description="Read about the two new metrics introduced in KARMA for ASR"
/>
