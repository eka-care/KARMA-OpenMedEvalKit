---
title: "KARMA: Knowledge Assessment and Reasoning for Medical Applications"
---
...
KARMA supports a wide range of models, datasets, and metrics for medical AI evaluation. To see the complete list of currently supported resources, visit our [**Supported Resources**](supported-resources) page, which is automatically updated with each release.
...
1. **[Models](user-guide/models/built-in-models)** - Unified interface for medical AI models
2. **[Datasets](user-guide/datasets/datasets_overview)** - Standardized medical evaluation datasets
3. **[Metrics](user-guide/metrics/metrics_overview)** - Comprehensive evaluation metrics
5. **[Processors](user-guide/processors/processors_overview)** - A way to post process the output of the model 
